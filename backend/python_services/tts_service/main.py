...
try:
    from shared.auth.token_verifier import firebase_auth_dependency
except ImportError:
    print("FATAL: Could not import 'firebase_auth_dependency'. Make sure 'shared/auth/token_verifier.py' exists.")
